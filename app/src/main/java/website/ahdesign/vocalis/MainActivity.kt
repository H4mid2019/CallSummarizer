...
import website.ahdesign.vocalis.companion.WatchSession
import website.ahdesign.vocalis.databinding.ActivityMainBinding
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                WatchSession.listening.collect { listening ->
                    binding.watchListeningBanner.visibility = if (listening) View.VISIBLE else View.GONE
                }
            }
        }
    }
